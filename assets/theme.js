...
theme.CollectionAjaxCart = (function() {
  ...
  CollectionAjaxCart.prototype = Object.assign({}, CollectionAjaxCart.prototype, {
    ...
    _updateCartPopupContent: function(item) {
      var quantity = 1; // Default quantity is 1 for collection page add to cart
    ...
    _setCartPopupPlaceholder: function(imageUrl, imageAspectRatio) {
      ...
      // Set placeholder size to maintain a consistent popup size
      var popupWidth = 260;
...
// Initialize the collection ajax cart feature
